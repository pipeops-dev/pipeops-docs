---
slug: deploy-ruby-sinatra-template
...
1. For this example, we shall test with the template project provided, which is on the right pane of the screen. Select **Pipeops-Ruby-Sinatra**.

   ![2.png](https://d23lxlhhocltbo.cloudfront.net/wp-content/uploads/2024/06/13102335/31-1.png)
